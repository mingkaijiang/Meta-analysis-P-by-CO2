metafor_co2_statistics_morphology_100 <- function(reDF) {
    
    ### create directory
    if(!dir.exists("output/statistics_co2_morphology_100")) {
        dir.create("output/statistics_co2_morphology_100", showWarnings = FALSE)
    }
    ...
    ### forest plot
    pdf("output/statistics_co2_morphology_100/leaf_area_morphology_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    ...
    ### forest plot
    pdf("output/statistics_co2_morphology_100/LMA_morphology_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_co2_morphology_100/SLA_morphology_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_co2_morphology_100/root_length_morphology_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
