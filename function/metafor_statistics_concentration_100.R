metafor_statistics_concentration_100 <- function(reDF) {
    ...
    ### make predictions
    preds <- predict(res1, newmods = c(1.25, 1.5, 2))
    ...
    ### forest plot
    pdf("output/statistics_concentration_100/leaf_N_concentration_response_ratio_mixed_effect_model.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_concentration_100/leaf_N_concentration_response_ratio_mixed_effect_model_categorical.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_concentration_100/leaf_N_concentration_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    pdf("output/statistics_concentration_100/leaf_N_concentration_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    ### check across models model performance
    pdf("output/statistics_concentration_100/leaf_P_concentration_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    funnel(res, main="Random effect model")
    funnel(res1, main="Mixed-effect model [CO2]")
    funnel(res2, main="Mixed-effect model [CO2 + P]")
    ...
    pdf("output/statistics_concentration_100/leaf_P_concentration_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    qqnorm(res, main="Random effect model")
    qqnorm(res1, main="Mixed-effect model [CO2]")
    qqnorm(res2, main="Mixed-effect model [CO2 + P]")
    ...
    ### check across models model performance
    pdf("output/statistics_concentration_100/root_P_concentration_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    funnel(res, main="Random effect model")
    funnel(res1, main="Mixed-effect model [CO2]")
    funnel(res2, main="Mixed-effect model [CO2 + P]")
    ...
    pdf("output/statistics_concentration_100/root_P_concentration_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    qqnorm(res, main="Random effect model")
    qqnorm(res1, main="Mixed-effect model [CO2]")
    qqnorm(res2, main="Mixed-effect model [CO2 + P]")
