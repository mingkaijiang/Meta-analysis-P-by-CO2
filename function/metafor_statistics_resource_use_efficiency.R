metafor_statistics_resource_use_efficiency <- function(reDF) {
    
    ### create directory
    if(!dir.exists("output/statistics_resource_use_efficiency")) {
        dir.create("output/statistics_resource_use_efficiency", showWarnings = FALSE)
    }
    ...
    ### forest plot
    pdf("output/statistics_resource_use_efficiency/WUE_resource_use_efficiency_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    ...
    ### forest plot
    pdf("output/statistics_resource_use_efficiency/WUE_resource_use_efficiency_response_ratio_mixed_effect_model.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_resource_use_efficiency/WUE_resource_use_efficiency_response_ratio_mixed_effect_model_categorical.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-16, 6), 
           at = log(c(0.05, 0.25, 1, 4)), atransf = exp,
    ...
    pdf("output/statistics_resource_use_efficiency/WUE_resource_use_efficiency_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    pdf("output/statistics_resource_use_efficiency/WUE_resource_use_efficiency_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
