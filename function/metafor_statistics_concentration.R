metafor_statistics_concentration <- function(reDF) {
    ...
    res <- rma(log_interaction, v_variance, data = tDF)
    ### forest plot
    pdf("output/statistics_concentration/stem_N_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_concentration/stem_P_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_concentration/total_N_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
