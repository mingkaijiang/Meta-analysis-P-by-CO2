metafor_co2_statistics_gas_exchange_100_eP <- function(reDF, sumDF) {
    ...
    sumDF$CO2_effect[sumDF$variable=="stomatal_conductance"&sumDF$P_treatment=="eP"] <- res$b
    sumDF$se[sumDF$variable=="stomatal_conductance"&sumDF$P_treatment=="eP"] <- res$se
