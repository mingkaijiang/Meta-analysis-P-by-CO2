metafor_co2_statistics_nutrient_ratio_100_aP <- function(reDF, sumDF) {
    
    ### create directory
    if(!dir.exists("output/statistics_nutrient_ratio_100_aP")) {
        dir.create("output/statistics_nutrient_ratio_100_aP", showWarnings = FALSE)
    }
    ...
    sumDF$CO2_effect[sumDF$variable=="leaf_NP"&sumDF$P_treatment=="aP"] <- res$b
    sumDF$se[sumDF$variable=="leaf_NP"&sumDF$P_treatment=="aP"] <- res$se
    ...
    sumDF$CO2_effect[sumDF$variable=="stem_NP"&sumDF$P_treatment=="aP"] <- res$b
    sumDF$se[sumDF$variable=="stem_NP"&sumDF$P_treatment=="aP"] <- res$se
    ...
    sumDF$CO2_effect[sumDF$variable=="root_NP"&sumDF$P_treatment=="aP"] <- res$b
    sumDF$se[sumDF$variable=="root_NP"&sumDF$P_treatment=="aP"] <- res$se
    ...
    sumDF$CO2_effect[sumDF$variable=="total_NP"&sumDF$P_treatment=="aP"] <- res$b
    sumDF$se[sumDF$variable=="total_NP"&sumDF$P_treatment=="aP"] <- res$se
