metafor_statistics_morphology_100 <- function(reDF, intDF) {
    ...
    ### forest plot
    pdf("output/statistics_morphology_100/leaf_area_morphology_response_ratio_mixed_effect_model.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_morphology_100/leaf_area_morphology_response_ratio_mixed_effect_model_categorical.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_morphology_100/leaf_area_morphology_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    pdf("output/statistics_morphology_100/leaf_area_morphology_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
