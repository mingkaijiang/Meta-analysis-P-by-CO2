metafor_statistics_morphology <- function(reDF) {
    
    ### create directory
    if(!dir.exists("output/statistics_morphology")) {
        dir.create("output/statistics_morphology", showWarnings = FALSE)
    }
    ...
    pdf("output/statistics_morphology/leaf_area_morphology_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    pdf("output/statistics_morphology/leaf_area_morphology_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
