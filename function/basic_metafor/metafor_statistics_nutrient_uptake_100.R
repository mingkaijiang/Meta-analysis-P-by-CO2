metafor_statistics_nutrient_uptake_100 <- function(reDF) {
    ...
    ### forest plot
    pdf("output/statistics_nutrient_uptake_100/plant_N_uptake_nutrient_uptake_response_ratio_mixed_effect_model.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_nutrient_uptake_100/plant_N_uptake_nutrient_uptake_response_ratio_mixed_effect_model_categorical.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_nutrient_uptake_100/plant_N_uptake_nutrient_uptake_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    pdf("output/statistics_nutrient_uptake_100/plant_N_uptake_nutrient_uptake_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
