metafor_statistics_gas_exchange_100 <- function(reDF) {
    ...
    ### forest plot
    pdf("output/statistics_gas_exchange_100/co2_assimilation_rate_gas_exchange_response_ratio_mixed_effect_model.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_gas_exchange_100/co2_assimilation_rate_gas_exchange_response_ratio_mixed_effect_model_categorical.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_gas_exchange_100/co2_assimilation_rate_gas_exchange_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    pdf("output/statistics_gas_exchange_100/co2_assimilation_rate_gas_exchange_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
