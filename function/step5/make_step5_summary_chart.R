...
make_step5_summary_chart <- function(sumDF, sumDF2, intDF) {
    ...
    pdf("output/step5/SFigure2_biomass_responses.pdf", width=14, height=6)
    ...
    p2a <- ggplot(plotDF2a)+ 
        ...
        geom_point(aes(y=id, x=P_effect_pct, fill=CO2_treatment), 
                   size=8, shape=21)+
        labs(x="LP response (%)", y="P concentration")+
        theme_linedraw()+
        theme(panel.grid.minor=element_blank(),
    ...
    p3a <- ggplot(plotDF3a)+ 
        ...
        geom_point(aes(y=id, x=P_effect_pct, fill=CO2_treatment), 
                   size=8, shape=21)+
        labs(x="LP response (%)", y="N concentration")+
        theme_linedraw()+
        theme(panel.grid.minor=element_blank(),
              axis.title.x = element_text(size=18), 
              axis.text.x = element_text(size=16),
    ...
    pdf("output/step5/SFigure4_concentration_responses.pdf", width=14, height=10)
    ...
    pdf("output/step5/SFigure1_gas_exchange_responses.pdf", width=16, height=6)
    plot_grid(p1a, p1b, p1c,
              rel_widths=c(1.0, 0.9, 1.0),
              labels=c(""), ncol=3, align="h", axis = "l")
    dev.off()
    ...
    pdf("output/step5/SFigure3_morphology_responses.pdf", width=16, height=6)
    plot_grid(p1a, p1b, p1c,
              rel_widths=c(1.0, 0.9, 1.0),
              labels=c(""), ncol=3, align="h", axis = "l")
    dev.off()
    ...
    pdf("output/step5/SFigure5_nutrient_uptake_responses.pdf", width=16, height=6)
    plot_grid(p1a, p1b, p1c,
              rel_widths=c(1.0, 0.9, 1.0),
              labels=c(""), ncol=3, align="h", axis = "l")
    dev.off()
    ...
    p1a <- ggplot(plotDF5a)+ 
        ...
        geom_point(aes(y=id, x=P_effect_pct, fill=CO2_treatment), 
                   size=4, shape=21)+
        labs(x="LP response (%)", y="P content")+
        theme_linedraw()+
        theme(panel.grid.minor=element_blank(),
              axis.title.x = element_blank(), 
              axis.text.x = element_blank(),
    ...
    p2a <- ggplot(plotDF6a)+ 
        ...
        geom_point(aes(y=id, x=P_effect_pct, fill=CO2_treatment), 
                   size=4, shape=21)+
        labs(x="LP response (%)", y="N content")+
        theme_linedraw()+
        theme(panel.grid.minor=element_blank(),
              axis.title.x = element_blank(), 
              axis.text.x = element_blank(),
    ...
    p3a <- ggplot(plotDF9a)+ 
        ...
        geom_point(aes(y=id, x=P_effect_pct, fill=CO2_treatment), 
                   size=4, shape=21)+
        labs(x="LP response (%)", y="Nutrient use efficiency")+
        theme_linedraw()+
        theme(panel.grid.minor=element_blank(),
              axis.title.x = element_blank(), 
              axis.text.x = element_blank(),
    ...
    pdf("output/step5/SFigure_S4.pdf", width=16, height=16)
    plot_grid(p1a, p1b, p1c,
              p2a, p2b, p2c,
              p3a, p3b, p3c,
              p4a, p4b, p4c,
