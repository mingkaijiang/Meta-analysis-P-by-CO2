make_step5_metafor_statistics_advanced <- function(inDF, intDF) {
    ...
    intDF <- step5_assign_model_stats_and_forest_plot_advanced(tDF, intDF, 
                                                               res, 
                                                               var.name="aboveground_biomass") 
    
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="aboveground_biomass")
    
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="aboveground_biomass")
    ...
    ### assign values and make forest plot
    intDF <- step5_assign_model_stats_and_forest_plot_advanced(tDF, intDF, res, 
                                                               var.name="leaf_biomass") 
    
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="leaf_biomass")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="leaf_biomass")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="stem_biomass")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="stem_biomass")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="root_biomass")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="root_biomass")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="total_biomass")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="total_biomass")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="leaf_N_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF,digits=5, control=list(stepadj=0.5))
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="leaf_N_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="leaf_P_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="leaf_P_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="stem_N_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="stem_N_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="stem_P_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="stem_P_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="root_N_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="root_N_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="root_P_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="root_P_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="total_N_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="total_N_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="total_P_content")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="total_P_content")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="leaf_N_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="leaf_N_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="leaf_P_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF,digits=5, control=list(stepadj=0.5))
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="leaf_P_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="root_P_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="root_P_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="stem_N_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="stem_N_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="stem_P_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="stem_P_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="root_N_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="root_N_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="total_N_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="total_N_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="total_P_concentration")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="total_P_concentration")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="CO2_assimilation_rate")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="CO2_assimilation_rate")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="stomatal_conductance")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="stomatal_conductance")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="leaf_area")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="leaf_area")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="LMA")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF,digits=5, control=list(stepadj=0.5))
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="LMA")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="SLA")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="SLA")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="Root_length")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="Root_length")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="leaf_NP")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF, digits=5,method="EB", control=list(stepadj=0.5,threshold=1e-8))
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="leaf_NP")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="stem_NP")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="stem_NP")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="root_NP")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="root_NP")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="total_NP")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="total_NP")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="N_uptake")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="N_uptake")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="P_uptake")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="P_uptake")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="WUE")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF,digits=5, control=list(stepadj=0.5))
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="WUE")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="NUE")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="NUE")
    ...
    ### funnel plot of the multivariate model
    make_step5_interaction_funnel_plot(res, var.name="PUE")
    
    ### leave one out analysis, based on simple model
    res2 <- rma.uni(log_interaction, v_variance, data=tDF)
    looDF <- leave1out(res2)
    make_step5_interaction_leave_one_out_plot(res, res2, looDF, var.name="PUE")
