metafor_statistics_nutrient_uptake <- function(reDF) {
    
    ### create directory
    if(!dir.exists("output/statistics_nutrient_uptake")) {
        dir.create("output/statistics_nutrient_uptake", showWarnings = FALSE)
    }
    ...
    ### forest plot
    pdf("output/statistics_nutrient_uptake/plant_N_uptake_nutrient_uptake_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    ...
    ### forest plot
    pdf("output/statistics_nutrient_uptake/plant_N_uptake_nutrient_uptake_response_ratio_mixed_effect_model.pdf",
        height=12, width=9)
    ...
    pdf("output/statistics_nutrient_uptake/plant_N_uptake_nutrient_uptake_response_ratio_mixed_effect_model_categorical.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-16, 6), 
           at = log(c(0.05, 0.25, 1, 4)), atransf = exp,
    ...
    pdf("output/statistics_nutrient_uptake/plant_N_uptake_nutrient_uptake_funnel_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    pdf("output/statistics_nutrient_uptake/plant_N_uptake_nutrient_uptake_qq_plot_intermodel_comparison.pdf")
    par(mfrow=c(2,2))
    ...
    ### forest plot
    pdf("output/statistics_nutrient_uptake/plant_P_uptake_nutrient_uptake_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-16, 6), 
           at = log(c(0.05, 0.25, 1, 4)), atransf = exp,
