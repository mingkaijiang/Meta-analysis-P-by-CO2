metafor_statistics_biomass <- function(reDF) {
    
    ### create directory
    if(!dir.exists("output/statistics_biomass")) {
        dir.create("output/statistics_biomass", showWarnings = FALSE)
    }
...
#
    ...
    ### forest plot
    pdf("output/statistics_biomass/root_P_content_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_biomass/total_P_content_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 6), 
           ylim = c(-3.5, l+3.5),
