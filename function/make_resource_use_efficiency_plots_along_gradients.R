make_resource_use_efficiency_plots_along_gradients <- function(inDF) {
    
    if(!dir.exists("output/gradient_resource_use_efficiency")) {
        dir.create("output/gradient_resource_use_efficiency", showWarnings = FALSE)
    }
    
    ### Subset biomass category
    bioDF <- subset(inDF, Category == "Resource Use Efficiency")
    
    bioDF1 <- bioDF[bioDF$Variable %in% c("NUE", "PUE", "WUE"),]
    ...
    pdf("output/gradient_resource_use_efficiency/summary_NUE_overall_plot.pdf", width=8, height=16)
    ...
    ### summary histgram of treatments
    pdf("output/gradient_resource_use_efficiency/summary_PUE_overall_plot.pdf", width=8, height=16)
    ...
    ### summary histgram of treatments
    pdf("output/gradient_resource_use_efficiency/summary_WUE_overall_plot.pdf", width=8, height=16)
