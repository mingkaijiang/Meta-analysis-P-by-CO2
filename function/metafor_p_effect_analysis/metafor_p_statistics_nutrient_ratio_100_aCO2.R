metafor_p_statistics_nutrient_ratio_100_aCO2 <- function(reDF, sumDF2) {
    ...
    sumDF2$P_effect[sumDF2$variable=="leaf_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$b
    sumDF2$se[sumDF2$variable=="leaf_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$se
    ...
    sumDF2$P_effect[sumDF2$variable=="stem_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$b
    sumDF2$se[sumDF2$variable=="stem_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$se
    ...
    sumDF2$P_effect[sumDF2$variable=="root_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$b
    sumDF2$se[sumDF2$variable=="root_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$se
    ...
    sumDF2$P_effect[sumDF2$variable=="total_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$b
    sumDF2$se[sumDF2$variable=="total_NP"&sumDF2$CO2_treatment=="aCO2"] <- res$se
