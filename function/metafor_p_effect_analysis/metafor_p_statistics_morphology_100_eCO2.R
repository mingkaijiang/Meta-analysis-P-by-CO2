metafor_p_statistics_morphology_100_eCO2 <- function(reDF, sumDF2) {
    ...
    sumDF2$ci_lb[sumDF2$variable=="leaf_area"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.lb
    sumDF2$ci_ub[sumDF2$variable=="leaf_area"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.ub
    ...
    sumDF2$ci_lb[sumDF2$variable=="LMA"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.lb
    sumDF2$ci_ub[sumDF2$variable=="LMA"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.ub
    ...
    sumDF2$ci_lb[sumDF2$variable=="SLA"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.lb
    sumDF2$ci_ub[sumDF2$variable=="SLA"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.ub
    ...
    sumDF2$ci_lb[sumDF2$variable=="Root_length"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.lb
    sumDF2$ci_ub[sumDF2$variable=="Root_length"&sumDF2$CO2_treatment=="eCO2"] <- res$ci.ub
