make_resource_use_efficiency_plots <- function(inDF) {
    ...
    p1 <- ggplot() +  
        ...
        annotate("rect", xmin = 2.8, xmax = 3.5, ymin = 250, ymax = 480,
                 alpha = .2, color="black", fill="white")+
        annotate("text", x=3.3, y=420, label=expression(aCO[2]), size=6)+
        annotate("text", x=3, y=420, label=expression(eCO[2]), size=6)+
        annotate("segment", x = 3.3, xend = 3.3, y = 270, yend = 370,
                 colour = "grey", size=1)+
        annotate("segment", x = 3.0, xend = 3.0, y = 270, yend = 370,
                 colour = "red", size=1)+
        annotate("segment", x = 3.25, xend = 3.35, y = 270, yend = 270,
                 colour = "grey", size=1)+
        annotate("segment", x = 3.25, xend = 3.35, y = 370, yend = 370,
                 colour = "grey", size=1)+
        annotate("segment", x = 2.95, xend = 3.05, y = 270, yend = 270,
                 colour = "red", size=1)+
        annotate("segment", x = 2.95, xend = 3.05, y = 370, yend = 370,
                 colour = "red", size=1)+
        geom_point(aes(x=3.3, y=320), color="black")+
        geom_point(aes(x=3.0, y=320), color="brown")
    ...
    p2 <- ggplot() +  
        ...
        coord_flip()+
        geom_hline(yintercept=0, linetype=2)+
        annotate("rect", xmin = 2.8, xmax = 3.5, ymin = 250, ymax = 350,
                 alpha = .2, color="black", fill="white")+
        annotate("text", x=3.3, y=330, label=expression(aP), size=6)+
        annotate("text", x=3, y=330, label=expression(eP), size=6)+
        annotate("segment", x = 3.3, xend = 3.3, y = 270, yend = 310,
                 colour = "grey", size=1)+
        annotate("segment", x = 3.0, xend = 3.0, y = 270, yend = 310,
                 colour = "red", size=1)+
        annotate("segment", x = 3.25, xend = 3.35, y = 270, yend = 270,
                 colour = "grey", size=1)+
        annotate("segment", x = 3.25, xend = 3.35, y = 310, yend = 310,
                 colour = "grey", size=1)+
        annotate("segment", x = 2.95, xend = 3.05, y = 270, yend = 270,
                 colour = "red", size=1)+
        annotate("segment", x = 2.95, xend = 3.05, y = 310, yend = 310,
                 colour = "red", size=1)+
        geom_point(aes(x=3.3, y=290), color="black")+
        geom_point(aes(x=3.0, y=290), color="brown")
