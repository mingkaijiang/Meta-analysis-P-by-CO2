plot_woody_nonwoody_comparison_2 <- function(intDF2, intDF3, sumDF2, sumDF3) {
    ...
    plotDF2$id <- c(2.8, 1.8, 0.8, 3.2, 2.2, 1.2)
    ...
    plotDF6$id <- plotDF7$id <- c(3.9, 4.1, 2.9, 3.1, 1.9, 2.1)
