metafor_p_statistics_concentration_100 <- function(reDF) {
    
    ### create directory
    if(!dir.exists("output/statistics_p_concentration_100")) {
        dir.create("output/statistics_p_concentration_100", showWarnings = FALSE)
    }
    ...
    ### forest plot
    pdf("output/statistics_p_concentration_100/leaf_N_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    ...
    ### forest plot
    pdf("output/statistics_p_concentration_100/leaf_P_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_p_concentration_100/root_P_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_p_concentration_100/stem_N_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_p_concentration_100/stem_P_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
    ...
    ### forest plot
    pdf("output/statistics_p_concentration_100/total_N_concentration_response_ratio_random_effect_model.pdf",
        height=12, width=9)
    forest(res, slab = tDF$Literature,
           xlim = c(-12, 4), 
           ylim = c(-3.5, l+3.5),
